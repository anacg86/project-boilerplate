      ...
      <nav className="navbar navbar-expand-lg bg-white sticky-top" id="mainNav">
        <div className="container">
          <div className="nav-item">
            <h1
              className="nav-link text-warning display-5  font-weight-bolder "
              href="/"
            >
              <Link
                className="text-warning display-5 font-weight-bolder h1"
                to="/"
              >
                Houdini
              </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ml-auto">
              <li className="nav-item">
                <a
                  className="nav-link js-scroll-trigger text-dark"
                  href="#about"
                >
                  About
                </a>
